public class Progarmelfers {
    public static void main(String[] args) {
       ...
       Mittarbeiter mitarbeiter = new Mittarbeiter("Holger", "Geldfuchs", adresseMitarbeiter);

        Kunde kunde1 = new Kunde("Klaus", "Sparbier", adresseKunde, mitarbeiter);
        Kunde kunde2 = new Kunde("Volker", "Vielgeld", adresseKunde, mitarbeiter);
        ...
        Sparkonto sparkonto1 = new Sparkonto(kunde1,3.0,23);
        ...
        if (girokonto1.uberweisen(2000, girokonto2)) {
            System.out.println(girokonto2);
            System.out.println(girokonto1);
        } else {
        ...
        if (girokonto1.uberweisen(100.0, girokonto2)) {
            System.out.println(girokonto1);
        } else {
            System.out.println("Fehler beim Überweisen");
        }
